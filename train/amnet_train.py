...
train_data = pd.read_csv('MoleculeDataset/train.csv', names= ['reactions', 'edits'])
valid_data =pd.read_csv('MoleculeDataset/valid.csv', names= ['reactions', 'edits'])
...
path = 'experiment1/05_10_edege_feature_golden_0'
